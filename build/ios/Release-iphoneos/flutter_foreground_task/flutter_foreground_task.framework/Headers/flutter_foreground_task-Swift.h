...
#ifndef FLUTTER_FOREGROUND_TASK_SWIFT_H
#define FLUTTER_FOREGROUND_TASK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_foreground_task",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC23flutter_foreground_task32SwiftFlutterForegroundTaskPlugin")
@interface SwiftFlutterForegroundTaskPlugin : NSObject <FlutterPlugin>
