...
import 'package:enxcalling/utils/size_config.dart';
...
const kPrimaryColor = Color(0xF59A1004);
...
const String urlBase = 'https://firebase-mt.vcloudx.com/' /*'https://meeting.enablex.io/'*/;
const userUrl = 'device';
const kCall = "call";
const kAnswer = "answer";
const kReject = "reject";
const kUnavailable = "unavailable";
const kInviteCall = "invite";
const kJoinInvitedCall = "join";
